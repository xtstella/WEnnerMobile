...
public class AntRxMesg extends Mesg {
   ...
   static {int field_index = 0;
      ...
      antRxMesg.addField(new Field("timestamp", TimestampFieldNum, 134, 1, 0, "s", false, Profile.Type.DATE_TIME));
      field_index++;
      antRxMesg.addField(new Field("fractional_timestamp", FractionalTimestampFieldNum, 132, 32768, 0, "s", false, Profile.Type.UINT16));
      field_index++;
      antRxMesg.addField(new Field("mesg_id", MesgIdFieldNum, 13, 1, 0, "", false, Profile.Type.BYTE));
      field_index++;
      antRxMesg.addField(new Field("mesg_data", MesgDataFieldNum, 13, 1, 0, "", false, Profile.Type.BYTE));
      ...
      antRxMesg.fields.get(field_index).components.add(new FieldComponent(4, false, 8, 1, 0)); // data
      field_index++;
      antRxMesg.addField(new Field("channel_number", ChannelNumberFieldNum, 2, 1, 0, "", false, Profile.Type.UINT8));
      field_index++;
      antRxMesg.addField(new Field("data", DataFieldNum, 13, 1, 0, "", false, Profile.Type.BYTE));
      field_index++;
   }
