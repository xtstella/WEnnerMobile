...
public class ItemArrayAdapter extends ArrayAdapter {
    ...
    public static String getDate(String strMilliSeconds) {
        ...
        strMilliSeconds = strMilliSeconds.substring(1, 10);
        ...
        Calendar cal2 = new GregorianCalendar(1989, 12, 31, 0, 0, 0);
        long diff1989 = cal2.getTime().getTime();                       //Wed Jan 31 00:00:00 GMT+01:00 1990   =>  633740400000
        System.out.println("cal before set: " + cal);          //time=1504080727770    2017/7/30
