...
import com.example.triviality.AfterQuiz;

import java.util.Stack;

public class QuizActivity extends Activity {
	private List<com.example.triviality.Question> quesList;
	int R1 = 0;
	int R2 = 0;
	int R3 = 0;
    private int qid=0;
    private com.example.triviality.Question currentQ;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		quesList = com.example.triviality.Question.addQuestions(getResources().getStringArray(R.array.Questions), getResources().getStringArray(R.array.Reponse), "0");
